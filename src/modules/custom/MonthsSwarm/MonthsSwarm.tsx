...
const MonthsSwarm = () => {
  ...
  return (
    <div className={`inno-months`}>
      ...
      <iframe src='https://flo.uri.sh/visualisation/8832826/embed'className='inno-months__iframe inno-months__iframe--philly' frameBorder='0' scrolling='no' sandbox='allow-same-origin allow-forms allow-scripts allow-downloads allow-popups allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation'></iframe>
      <iframe src='https://flo.uri.sh/visualisation/8832811/embed'className='inno-months__iframe inno-months__iframe--pa' frameBorder='0' scrolling='no' sandbox='allow-same-origin allow-forms allow-scripts allow-downloads allow-popups allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation'></iframe>
      ...
      <iframe src='https://flo.uri.sh/visualisation/8833220/embed'className='inno-months__iframe inno-months__iframe--aug' frameBorder='0' scrolling='no' sandbox='allow-same-origin allow-forms allow-scripts allow-downloads allow-popups allow-popups-to-escape-sandbox allow-top-navigation-by-user-activation'></iframe>
